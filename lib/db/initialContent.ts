  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        id: 'm2_q11',
        type: 'MCQ',
        question: '11. Which search method explores a problem level by level?',
        options: ['DFS', 'BFS', 'Decision Tree', 'Heuristic'],
        correctOptionIndex: 1,
        marks: 1,
        modelAnswer: 'BFS',
        explanation: 'Breadth-First Search (BFS) explores all nodes level by level across the search space.',
      },
      {
        id: 'm2_q12',
        type: 'MCQ',
        question: '12. Which search method explores one path deeply before trying another?',
        options: ['BFS', 'DFS', 'Heuristic', 'Decision Tree'],
        correctOptionIndex: 1,
        marks: 1,
        modelAnswer: 'DFS',
        explanation: 'Depth-First Search (DFS) explores as far as possible along one branch before backtracking.',
      },
      {
        id: 'm2_q13',
        type: 'MCQ',
        question: '13. What is a heuristic in AI?',
        options: [
          'A smart shortcut or estimate used to guide problem solving',
          'A type of computer',
        ...
        correctOptionIndex: 0,
        marks: 1,
        modelAnswer: 'A smart shortcut or estimate used to guide problem solving',
        explanation: 'A heuristic is a smart shortcut or estimate used to guide problem solving.',
      },
      {
        id: 'm2_q14',
        type: 'MCQ',
        question: '14. Why does AI use heuristics?',
        options: [
          'To help find a good solution more efficiently',
        ...
        correctOptionIndex: 0,
        marks: 1,
        modelAnswer: 'To help find a good solution more efficiently',
        explanation: 'AI uses heuristics to help find a good solution more efficiently without exhaustive search.',
      },
      {
        id: 'm2_q15',
        type: 'MCQ',
        question: '15. What does a decision tree use to solve a problem?',
        options: [
          'Branching questions and choices',
          'Only numbers',
          'Random images',
          'Computer networks',
        ],
        correctOptionIndex: 0,
        marks: 1,
        modelAnswer: 'Branching questions and choices',
        explanation: 'A decision tree uses branching questions and choices to systematically arrive at a solution.',
      },
      {
        id: 'm2_q16',
        type: 'MCQ',
        question: '16. What is the main purpose of AI problem solving?',
        options: [
          'To find a suitable solution to a given problem',
        ...
        correctOptionIndex: 0,
        marks: 1,
        modelAnswer: 'To find a suitable solution to a given problem',
        explanation: 'The main purpose of AI problem solving is to find a suitable solution to a given problem.',
      },
      {
        id: 'm2_q17',
        type: 'MCQ',
